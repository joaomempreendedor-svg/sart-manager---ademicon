...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <AppContext.Provider value={{ 
      ...
      addTeamMember, updateTeamMember: () => {}, deleteTeamMember, toggleTheme, addOrigin, addInterviewer, addPV, addCandidate, updateCandidate, toggleChecklistItem, toggleConsultantGoal, setChecklistDueDate, getCandidate, saveTemplate,

...
export const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-800 min-h-screen flex flex-col fixed left-0 top-0 transition-colors duration-200 z-50">
      {/* Logo Area */}
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        <NavLink to="/config-team" className={linkClass}>
          <Users className="w-5 h-5" />
          <span>Gestão de Equipe</span>
        </NavLink>
        <NavLink to="/config-process" className={linkClass}>
          <Settings className="w-5 h-5" />
          <span>Editar Processo</span>
        </NavLink>
        <NavLink to="/config-goals" className={linkClass}>
          <Target className="w-5 h-5" />
          <span>Configurar Metas</span>
        </NavLink>
        <NavLink to="/config-interview" className={linkClass}>

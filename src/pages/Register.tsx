...
import { TrendingUp, Lock, Mail, User, Loader2, ArrowRight, CheckCircle2 } from 'lucide-react';
        ...
        <div className="bg-white dark:bg-slate-800 py-8 px-4 shadow-xl rounded-xl sm:px-10 border border-gray-100 dark:border-slate-700">
          {registrationSuccess ? (
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Cadastro Realizado com Sucesso!</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Por favor, verifique seu e-mail para confirmar sua conta e ativar seu acesso.
              </p>
              <button

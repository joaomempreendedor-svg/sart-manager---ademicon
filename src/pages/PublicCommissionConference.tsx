        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center space-x-3 overflow-hidden">
            ...
            <div className="min-w-0">
              ...
              <p className="text-lg font-bold text-gray-900">{filteredCommissions.filter(c => c.myRole === 'consultant').length}</p>
            </div>
          </div>
          <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center space-x-3 overflow-hidden">
            ...
            <div className="min-w-0">
              ...
              <p className="text-lg font-bold text-gray-900">{filteredCommissions.filter(c => c.myRole === 'angel').length}</p>
            </div>
          </div>
          <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center space-x-3 overflow-hidden">

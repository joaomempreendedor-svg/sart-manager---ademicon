...
import { Processos } from '@/pages/gestor/Processos'; // NOVO: Importar Processos
import { ProcessEditorPage } from '@/pages/gestor/ProcessEditorPage'; // NOVO: Importar ProcessEditorPage
    ...
    <Routes>
      ...
      <Route element={<RequireAuth allowedRoles={['GESTOR', 'ADMIN', 'SECRETARIA']} />}>
        <Route path="/gestor" element={<GestorLayout />}>
          ...
          <Route path="processos/:processId" element={<ProcessEditorPage />} />
        </Route>

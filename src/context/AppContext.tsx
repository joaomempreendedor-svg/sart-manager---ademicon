...
Em seguida, reorganizando a lógica na função Edge:

<dyad-write path="supabase/functions/create-crm-lead-from-cold-call/index.ts" description="Reorganizando a lógica de seleção de etapa para priorizar 'Demonstrou Interesse' e 'Reunião'.">

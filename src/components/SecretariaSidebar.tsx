...
import { LogOut, User as UserIcon, Sun, Moon, TrendingUp, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const SecretariaSidebar: React.FC<SecretariaSidebarProps> = ({ isSidebarOpen, toggleSidebar, isSidebarCollapsed, toggleSidebarCollapse }) => {
    ...
    <>
      ...
      <div className={`bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-800 h-screen flex flex-col fixed left-0 top-0 transition-all duration-300 z-50 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'} ${isSidebarCollapsed ? 'md:w-20' : 'md:w-64'} w-64`}>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto custom-scrollbar">
          {/* Sem links de navegação para a Secretaria, conforme solicitado */}

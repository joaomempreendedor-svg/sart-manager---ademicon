                ...
                <div key={log.id} className="bg-white dark:bg-slate-700 p-4 rounded-lg border border-gray-200 dark:border-slate-600 shadow-sm">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                      ...
                      log.result === 'Pedir retorno' || log.result === 'Conversou' || log.result === 'Demonstrou Interesse' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300' :
